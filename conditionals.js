...
// ? if the hours are between 12-5pm the greeting should be "Good Afternnon" and if it's between 5-12am the greeting should be "Good Evening"
...
5. Code for the false 
        (1)                (2)          (3)                 (4)     (5)
 isMilitaryMember === true ? (priceOfTicket = priceOfTicket -1) : 
 (priceOfTicket = priceOfTicket)
 */
 ...
 let currentTimeInSeconds = currentDateTime.getTime() / 1000
...
console.log(currentTimeInSeconds % 2 === 0) ? 
console.log(`The Current second is ${currentTimeInSeconds } and it is even`):
console.log(`The current second is ${currentTimeInSeconds} and it is odd`); 
